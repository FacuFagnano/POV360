                      ...
                      <div className="mt-5 flex flex-wrap gap-2">
                        {service.links.map((link) => (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center justify-center rounded-full border border-[#0A0A0A] bg-[#0A0A0A] px-4 py-2 text-xs font-semibold shadow-[0_8px_20px_rgba(10,10,10,0.18)] transition-all duration-300 hover:border-[#9db7d3]/70 hover:bg-[#111111] !text-white"
                          >
                            {link.label}
                          </a>
                        ))}
